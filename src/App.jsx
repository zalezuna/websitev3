  ...
  return (
    <div className="bg-brand-bg text-brand-textPrimary">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <nav className="hidden md:flex space-x-8">
              ...
              <a href="#mvp" className="text-sm font-medium text-brand-textSecondary hover:text-brand-primary transition-colors">MVP Solutions</a>
              <a href="#why-us" className="text-sm font-medium text-brand-textSecondary hover:text-brand-primary transition-colors">Why Us</a>
              <a href="#team" className="text-sm font-medium text-brand-textSecondary hover:text-brand-primary transition-colors">Our Team</a>
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden absolute top-16 inset-x-0 bg-brand-bg shadow-lg py-2">
            <nav className="container mx-auto px-4 space-y-1">
              ...
              <a href="#mvp" onClick={closeMobileMenu} className="block px-3 py-2 rounded-md text-base font-medium text-brand-textSecondary hover:text-brand-primary hover:bg-brand-bgSubtle">MVP Solutions</a>
              ...
              <a href="#team" onClick={closeMobileMenu} className="block px-3 py-2 rounded-md text-base font-medium text-brand-textSecondary hover:text-brand-primary hover:bg-brand-bgSubtle">Our Team</a>
      ...
      <main className="pt-16"> {/* Offset for fixed header */}
        ...
        <section id="mvp" className="py-16 md:py-24 bg-brand-bg">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold tracking-tight text-brand-primary sm:text-4xl">MVP Solutions</h2>
